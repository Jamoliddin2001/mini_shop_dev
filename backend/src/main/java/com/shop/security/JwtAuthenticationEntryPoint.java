...
import com.shop.error.ApiError;
...
/**
 * Renders 401 responses for unauthenticated access to protected endpoints, reusing the unified
 * {@link ApiError} format (security failures in the filter chain never reach
